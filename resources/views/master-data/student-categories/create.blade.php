...
@section('header', 'Tambah Kategori Siswa')

@section('content')
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 border-b border-gray-200">
                <h3 class="font-bold text-lg text-gray-800">Form Tambah Kategori</h3>
                <p class="text-sm text-gray-500 mt-1">Isi data kategori siswa baru</p>
            </div>

            <form method="POST" action="{{ route('master-data.student-categories.store') }}" class="p-6 space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code') }}" required
                        ...
                        placeholder="Contoh: REGULER, YATIM, DHUAFA">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                        ...
                        placeholder="Contoh: Reguler, Yatim Piatu">
                ...
                <div>
                    ...
                    <input type="number" name="discount_percentage" id="discount_percentage"
                        value="{{ old('discount_percentage', 0) }}" required min="0" max="100" step="0.01"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-sm">
